...
## Corpus Check
- 48 files · ~202,981 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 252 nodes · 379 edges · 18 communities (10 shown, 8 thin omitted)
- Extraction: 97% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e40da69a`
...
Cohesion: 0.08
Nodes (25): Warning: This Next.js Version Has Breaking Changes vs Training Data, ArivMinecraftTrivia/pipeline/fetch_minecraft_data.py, ArivMinecraftTrivia/pipeline/select_blocks.py, ArivMinecraftTrivia/pipeline/wiki_scraper.py, build-output.txt — Next.js Build Log (failed build), .claude/Agents/github-issue-workflow.md (external merge-process doc), Pre-Merge Documentation Check Process, nextConfig (+17 more)

### Community 1 - "Game UI Screens & Audio"
Cohesion: 0.09
Nodes (29): 8-Slot Crafting Table Win Condition, Streak-Weighted Scoring System, Game Over Hero Image (gameover-hero.png), Minecraft Hero Image (Surfing Character Scene), CraftingGrid(), CraftingGridProps, GameContainer(), CONFETTI_COLORS (+21 more)
...
Cohesion: 0.11
Nodes (22): GET(), QuestionRow, ArivMinecraftTrivia/pipeline/merge.py, ArivMinecraftTrivia/pipeline/texture_resolver.py, CLAUDE.md — Minecraft Block Trivia Development Guide, Rationale: Per-Block Texture Resolution via Wiki File: Namespace, answerType Taxonomy (toolTier/blastResistance/yLevelRange/lightLevel/boolean), Batch Question Fetching (batches of 5, silent background refill) (+14 more)

### Community 7 - "Crafting Game Mechanics"
Cohesion: 0.26
Nodes (13): GameRules.md — Minecraft Block Trivia Game Rules, Rules.md (superseded prototype spec: fixed 5-question quiz, no penalties, 25-block corpus), AnswerOptions(), AnswerOptionsProps, FeedbackPanel(), FeedbackPanelProps, GameScreen(), getAudioContext() (+5 more)
...
- **Why does `CLAUDE.md — Minecraft Block Trivia Development Guide` connect `Database & API Layer` to `Project Docs & Data Pipeline`, `Game UI Screens & Audio`, `Question Generation Pipeline`, `Crafting Game Mechanics`?**
